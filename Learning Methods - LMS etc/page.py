...
def crossValidate(complete,folds,algo,comb):
	...
	for i in range(folds):
		...
		for k in confusion[1]:
			for sj in confusion[1][k]:
				finalConf[k][sj] = finalConf[k][sj] + confusion[1][k][sj]
	avErr = errSum/folds
	print "error", avErr
	sqrSum = sqrSum/folds
...
a = Dataset()
a.readData("page.data")
a.writeData("page")
#print a.data[0].feature, a.data[0].classLabel
#l = splitDataset(a,4)
#l[0].writeData("1")
#l[1].writeData("2")
#l[2].writeData("3")
